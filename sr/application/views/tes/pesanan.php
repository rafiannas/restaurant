        ...
        <table class="table table-borderless" style="background-color: #FFFFFF" id="myTable">
          ...
          <!--
                <tbody>
                    <tr>
                        <td>
                        <a class="details_daftar_pesanan style="color:#fff;">details</a>
                        <a class="pembayaran btn" style="color:#fff;">Pembayaran</a>
                        <a class="batalkan btn"style="color:#fff;">Batalkan</a>
                        </td>
                    </tr>
                </tbody>
                -->
