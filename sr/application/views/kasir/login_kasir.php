  ...
  <div class="row justify-content-center">
    ...
    <div class="col-xl-12 col-lg-12 col-md-9">
      ...
      <div class="card o-hidden border-0 shadow-lg col-lg-7 mx-auto">
        <h2 class="h4 text-gray-900 mt-2" style="text-align: center; margin-top:10px"><i class="fas fa-cash-register fa-4x"></i></h2>
          ...
          <div class="row">
            ...
            <div class="col-lg">
              <div class="p-5">
                ...
                <form class="user" method="post" action=" <?= base_url('kasir'); ?> ">
